        ...
        <!-- login left -->
          ...
          <div class="col-md-8 rounded-start-4 right-box" style="background-color: #fcc822">
            ...
            <div class="content mx-5">
              ...
              <small>Login ke akunmu</small></p>
                <?php if(isset($error)) : ?>
                    <p><small>Username/password Salah</small></p>
                <?php endif; ?>
              ...
              <div class="bottom-container">
                <p><small>Belum punya akun?
                <a href="register.php" class="text-decoration-none">Daftar</a></small></p>
